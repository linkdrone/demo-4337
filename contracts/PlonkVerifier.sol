...
contract PlonkVerifier {
    ...
    uint256 constant Qmx = 20827392284080912072284802866983774143554409228535350491928473679197366196780;
    uint256 constant Qmy = 11623390660018229410607224484590489828819357769381492690342217718124312574390;
    uint256 constant Qlx = 3315745479308632161825764866088227971615631935716388309907172531503754878418;
    uint256 constant Qly = 198714724922332380817517481997032563182572966446508063260234177715626558924;
    uint256 constant Qrx = 5754981519738181263922678668660638822294389892547399596826785771511704865241;
    uint256 constant Qry = 4326083080895221405804908820043966547155738508034503314189053503702717104246;
    uint256 constant Qox = 21376644089352042982920780168689113443064635163287606778643426142425668092597;
    uint256 constant Qoy = 3110647101879891270155308342826290895555315215180648036705580873235841439398;
    uint256 constant Qcx = 0;
    uint256 constant Qcy = 0;
    uint256 constant S1x = 8465859484789476274009746979542366256897027353545282761343324382968665300260;
    uint256 constant S1y = 11716603344738728146363558497881577032382757793624066883279961456427397539331;
    uint256 constant S2x = 7739342328573711629722158761302024923772409067313366000331072401618405344984;
    uint256 constant S2y = 12514243605680764586470417752213960726075218324657405065822105680385226656213;
    uint256 constant S3x = 1831154540842803290904162534559179695624781204690913671140126632602458043760;
    uint256 constant S3y = 9262444430036155573620648128535303229634790911892051652678971314382357950207;
    uint256 constant k1 = 2;
    uint256 constant k2 = 3;
    uint256 constant X2x1 = 11859083161859576955455891818847194317865315832724989868852207889153645350008;
    uint256 constant X2x2 = 917534205150833460920546191354232299989619463840501702019605437555082364707;
    uint256 constant X2y1 = 9014699969306724320316663174278909824690248156900436936958621196270660740223;
    uint256 constant X2y2 = 7775783656337533312272132153410082756190052295319315808919804206462222768595;
    ...
    function verifyProof(bytes memory proof, uint[] memory pubSignals) public view returns (bool) {
        assembly {
            ...
            function calculatePl(pMem, pPub) {
                ...
                pl := mod(add(sub(pl, mulmod(mload(add(pMem, pEval_l1)), mload(add(pPub, 32)), q)), q), q)
